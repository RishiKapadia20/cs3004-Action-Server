...
public class ActionServerThread extends Thread {
  ...
  //Setup the thread
  	public ActionServerThread(Socket actionSocket, String ActionServerThreadName, SharedActionState SharedObject,String account) {
    ...
    try {
      ...
      while ((inputLine = in.readLine()) != null) {
    	  ...
    	  try { 
    		  ...
    		  outputLine = mySharedActionStateObject.processInput(myActionServerThreadName, inputLine,myAccount);
